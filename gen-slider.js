...
for (const [title, details] of Object.entries(data)) {
    ...
    html += `                    <!-- Service ${count} -->\n`;
    html += `                    <a href="/services/${slug}.html" class="stripe-card p-8 flex-none w-[85vw] md:w-[400px] snap-start group hover:-translate-y-2 hover:shadow-xl transition-all duration-300 border border-transparent hover:border-[#635bff] bg-white rounded-xl">\n`;
