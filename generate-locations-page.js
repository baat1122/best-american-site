...
states.forEach(state => {
    ...
    cardsHtml += `
            <a href="routes/${slug}-car-shipping.html" class="flex items-start gap-4 p-5 rounded-2xl border border-[#e6e6e6] bg-white hover:border-[#800020] hover:shadow-md transition-all group">
                ...
                <div>
                    <h4 class="font-bold text-[#0a2540] group-hover:text-[#800020] transition-colors">${state}</h4>
...
<head>
    ...
    <title>All Locations | Best American Auto Transport Inc</title>
    ...
    <header class="bg-[#0a2540] w-full z-50 transition-all duration-300">
        <div class="container mx-auto px-4 lg:px-8 py-5 flex justify-between items-center">
            ...
            <div class="hidden lg:flex items-center gap-4">
                ...
                <a href="/quote/" class="bg-[#800020] text-white px-5 py-2 rounded-full font-bold hover:bg-[#5c0017] transition">Cost Calculator</a>
            </div>
        </div>
    </header>
    ...
    <main class="py-24">
        <div class="container mx-auto px-4 lg:px-8 max-w-7xl">
            <div class="mb-12 text-center max-w-2xl mx-auto">
                ...
                <p class="text-lg text-[#425466]">Best American Auto Transport Inc provides reliable, coast-to-coast car shipping services across all 50 states. Select your state below to find local transport guides and instant rates.</p>
            </div>
