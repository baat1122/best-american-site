...
const BASE_URL = 'https://neonautotransport.com';
...
const services = [
  {
    ...
    title: 'Open Car Transport Service | Affordable Nationwide Auto Shipping | Neon Auto Transport',
    desc: 'Ship your vehicle affordably with Neon Auto Transport open transport service. Multi-car trailers, FMCSA approved, door-to-door nationwide delivery. Get an instant quote.',
  ...
  },
  {
    ...
    title: 'Enclosed Auto Transport | Premium Car Shipping Protection | Neon Auto Transport',
    desc: 'Protect your luxury, classic, or exotic car with Neon Auto Transport enclosed car shipping. Fully covered trailer, weather protection, FMCSA approved. Get a free quote today.',
  ...
  },
  {
    ...
    title: 'Door-to-Door Car Transport | Pickup & Delivery at Your Location | Neon Auto Transport',
    desc: 'Neon Auto Transport offers true door-to-door car shipping. We pick up and deliver your vehicle directly to your address — no terminals. FMCSA approved, nationwide coverage.',
  ...
  },
  {
    ...
    title: 'Expedited Auto Transport | Priority Car Shipping in 24-48 Hours | Neon Auto Transport',
    desc: 'Need your car shipped fast? Neon Auto Transport expedited service guarantees priority pickup and delivery. Team drivers, faster routes. Get priority auto transport today.',
  ...
  },
  {
    ...
    title: 'Motorcycle Shipping Service | Safe Nationwide Bike Transport | Neon Auto Transport',
    desc: 'Ship your motorcycle safely across the country with Neon Auto Transport. Palletized or crated transport, fully insured, FMCSA approved. Get a free motorcycle shipping quote.',
  ...
  },
  {
    ...
    title: 'Alaska Auto Transport | Car Shipping to & from Alaska | Neon Auto Transport',
    desc: 'Shipping a car to or from Alaska? Neon Auto Transport handles all Alaska vehicle transport logistics including ferry coordination and mainland pickup. Get an instant Alaska quote.',
  ...
  },
  {
    ...
    title: 'Hawaii Auto Transport | Ship Your Car to Hawaii | Neon Auto Transport',
    desc: 'Ship your vehicle to or from Hawaii with Neon Auto Transport. We manage all port and ocean freight logistics for seamless Hawaii car shipping. FMCSA approved, fully insured.',
  ...
  },
  {
    ...
    title: 'Military Car Shipping | Discounted Auto Transport for Service Members | Neon Auto Transport',
    desc: 'Neon Auto Transport proudly offers discounted car shipping for active military, veterans, and their families. PCS moves covered. FMCSA approved, nationwide service.',
  ...
  },
  {
    ...
    title: 'Luxury & Exotic Car Shipping | White-Glove Auto Transport | Neon Auto Transport',
    desc: 'White-glove enclosed transport for luxury, exotic, and collector vehicles. Ferrari, Lamborghini, Rolls-Royce, and more. Neon Auto Transport ensures your prized car arrives perfect.',
  ...
  },
  {
    ...
    title: 'Car Dealer Auto Transport | Fleet Shipping for Dealerships | Neon Auto Transport',
    desc: 'Neon Auto Transport partners with car dealerships for reliable fleet and individual unit shipping. Competitive rates, fast transit, FMCSA approved carrier network.',
  ...
  },
  {
    ...
    title: 'Corporate Relocation Car Shipping | Employee Vehicle Transport | Neon Auto Transport',
    desc: 'Simplify corporate relocations with Neon Auto Transport. We ship employee vehicles safely during company moves. Volume pricing, coordinated logistics, nationwide coverage.',
  ...
  },
  {
    ...
    title: 'College Student Car Shipping | Affordable Campus Auto Transport | Neon Auto Transport',
    desc: 'Heading to college? Ship your car to campus safely with Neon Auto Transport. Student-friendly pricing, door-to-door delivery, FMCSA approved. Get a free college car shipping quote.',
  ...
  },
  {
    ...
    title: 'Fleet Management Transportation | Multi-Vehicle Shipping Solutions | Neon Auto Transport',
    desc: 'Neon Auto Transport offers scalable fleet management and multi-vehicle shipping for businesses. Coordinate transport of 5 to 500+ vehicles with our dedicated fleet team.',
  ...
  },
  {
    ...
    title: 'International Car Shipping | Overseas Vehicle Transport | Neon Auto Transport',
    desc: 'Ship your vehicle internationally with Neon Auto Transport. We handle customs, ocean freight, and overseas logistics for car shipping to 150+ countries. Get a free international quote.',
  ...
  },
  {
    ...
    title: 'Auto Auction Car Shipping | Fast Vehicle Transport from Auctions | Neon Auto Transport',
    desc: 'Won a vehicle at auction? Neon Auto Transport specializes in fast, reliable auction car pickup and delivery. Copart, IAAI, Manheim, and all major auctions served.',
  ...
  },
  {
    ...
    title: 'Car Buyer Auto Transport | Vehicle Delivery After Purchase | Neon Auto Transport',
    desc: 'Just bought a car online or out of state? Neon Auto Transport delivers your new purchase right to your door. FMCSA approved, fully insured, nationwide delivery.',
  ...
  },
  {
    ...
    title: 'Auto Transport for Car Resellers | Reliable Vehicle Shipping | Neon Auto Transport',
    desc: 'Car resellers and flippers trust Neon Auto Transport for fast, reliable vehicle shipping. Competitive rates, priority scheduling, and nationwide carrier network.',
  ...
  },
  {
    ...
    title: 'Car Shipping to Another State | Nationwide Interstate Auto Transport | Neon Auto Transport',
    desc: 'Moving or selling across state lines? Neon Auto Transport ships cars to any state in the US. Door-to-door interstate auto transport, FMCSA approved, instant online quotes.',
  ...
  },
  {
    ...
    title: 'Rental Car Shipping | Fleet Relocation for Rental Companies | Neon Auto Transport',
    desc: 'Neon Auto Transport provides specialized rental car fleet relocation services. Move your rental vehicles between locations quickly and cost-effectively. Get a fleet quote.',
  ...
  },
  {
    ...
    title: 'Snowbird Car Shipping | Seasonal Vehicle Transport Florida & Arizona | Neon Auto Transport',
    desc: 'Heading south for the winter? Neon Auto Transport is the #1 snowbird car shipping company. Ship your vehicle to Florida, Arizona, or any warm state. Schedule your seasonal transport now.',
  ...
  },
  {
    ...
    title: 'Truck Shipping Services | Pickup Truck & Commercial Transport | Neon Auto Transport',
    desc: 'Ship your pickup truck, work truck, or commercial vehicle with Neon Auto Transport. Open and enclosed options available. FMCSA approved, fully insured, nationwide coverage.',
...
<head>
    ...
    <meta property="og:title" content="${state} Car Shipping | Neon Auto Transport">
    <meta property="og:description" content="Reliable, FMCSA approved car shipping to and from ${state}. Serving ${hub} and all cities in ${state}. Door-to-door auto transport along ${highway}. Call (571) 576-7711.">
    ...
    <meta name="twitter:title" content="${state} Car Shipping | FMCSA Approved | Neon Auto Transport">
    <meta name="twitter:description" content="Ship your car to or from ${state} with Neon Auto Transport. Door-to-door delivery along ${highway}. Serving ${hub}. Instant quote available.">
    ...
    <script type="application/ld+json">
    {
      ...
      "offers": {
        ...
        "seller": { "@type": "Organization", "name": "Neon Auto Transport" }
      }
    }
    </script>
    <script type="application/ld+json">
...
<head>
    ...
    <meta property="og:description" content="${svc.hook} FMCSA &amp; DOT approved. Fully insured. Get a free quote from Neon Auto Transport.">
    <meta property="og:image" content="${OG_IMAGE}">
    <meta property="og:image:width" content="1200">
    <meta property="og:image:height" content="630">
    <meta property="og:site_name" content="Neon Auto Transport">
